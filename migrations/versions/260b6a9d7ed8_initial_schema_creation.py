...
Revision ID: 260b6a9d7ed8
Revises: 8500d6ba2c0e
Create Date: 2025-07-24 00:13:37.199513
...
revision = '260b6a9d7ed8'
down_revision = '8500d6ba2c0e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('emp_id', 'date')
    )
